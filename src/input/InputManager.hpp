...
namespace re
{
	namespace input
	{
		...
		public:
			...
			@param[in] key:
				The Key enum value representing the Key to return.
			@return
				the KeyState associated with key.
			@see InputManager::keystate, KeyStat. */
			...
			@param[in] key:
				The Key enum value representing the Key to return.
			@return
				whether the KeyState is KeyState::Held or KeyState::Idle
